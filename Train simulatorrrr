...
int main() {
	...
	addFront(&head, 3543, tanker, false);
	addFront(&head, 6271, caboose, true);
	addFront(&head, 231, passenger, true);

	addAfter(head->next, 245, passenger, true);
	addAfter(head->next, 69420, tanker, false);
